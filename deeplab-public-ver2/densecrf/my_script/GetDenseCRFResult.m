...
addpath('/home/dhubel/deeplab_v2/deeplab-public-ver2/matlab/my_script');
SetupEnv;
...
if is_server
  if learn_crf
    ...
    map_folder = fullfile('/home/dhubel/deeplab_v2', dataset, 'densecrf', 'res', feature_name, model_name, testset, feature_type, post_folder); 

    save_root_folder = fullfile('/home/dhubel/deeplab_v2', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder); ;
  else
    post_folder = sprintf('post_densecrf_W%d_XStd%d_RStd%d_PosW%d_PosXStd%d', bi_w, bi_x_std, bi_r_std, pos_w, pos_x_std);

    map_folder = fullfile('/home/dhubel/deeplab_v2', dataset, 'res', feature_name, model_name, testset, feature_type, post_folder); 
